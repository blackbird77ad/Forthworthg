  ...
  return (
    <div className='project-pg'>
      <div className='project-div'>
        <img src={prot1} alt="Project" width="450px" height="250px"/> 
        <img src={prot2} alt="Project2" width="450px" height="250px" />
      </div>
      
      <div className='project-div2'>
        <img src={prot3} alt="Project3" width="450px" height="250px" />
        <img src={prot4} alt="Project4" width="450px" height="250px" />
      </div>
    </div>
  )
}
